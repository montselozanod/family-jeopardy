...
export const questions: Question[] = [
  ...
  { id: 82, categoryId: 'historia', q: '¿Cómo se llama y en qué ciudad nació la nieta mayor de Siti?', a: 'La Nena - Nació en Austin', points: 150 },
  { id: 15, categoryId: 'historia', q: '¿En qué pueblo del Líbano nació el abuelito Rachid?', a: 'Baicun, Líbano', points: 150 },
  { id: 16, categoryId: 'historia', q: '¿A qué ciudad mexicana llegó el abuelito Rachid en barco y cuántos años tenía?', a: 'Tampico, tenía 15 años', points: 150 },
  { id: 17, categoryId: 'historia', q: '¿En qué ciudad nació la abuelita Elenita?', a: 'Ciudad Victoria', points: 150 },
  { id: 18, categoryId: 'historia', q: '¿Cuál es el nombre completo de Buchita?', a: 'Tiburcia Camacho Ortiz', points: 200 },
  { id: 19, categoryId: 'historia', q: '¿En qué mes y año se mudó la familia a Privada Río Sena?', a: 'Enero de 2007', points: 200 },
  { id: 20, categoryId: 'historia', q: 'Menciona AL MENOS 3 primos que NO se casaron en Monterrey', a: 'Lulita, Coki, Neto, Pedrito, Alf (cualquier 3 son correctos)', points: 200 },
  { id: 21, categoryId: 'historia', q: '¿Cómo se llamaba la mamá del abuelito Chano?', a: 'Margarita', points: 300 },
  { id: 22, categoryId: 'historia', q: '¿En qué colegio estudió la primaria el abuelito Chano?', a: 'Colegio Franco Mexicano', points: 300 },
  { id: 23, categoryId: 'historia', q: '¿Qué presidente de México era amigo personal del abuelito Chano?', a: 'Gustavo Díaz Ordaz', points: 350 },
  { id: 24, categoryId: 'historia', q: '¿A qué líder internacional conoció el abuelito Chano?', a: 'Fidel Castro', points: 350 },
  { id: 25, categoryId: 'historia', q: '¿Cómo se llamaba la tienda de telas del abuelito Rachid?', a: 'Telas Primavera', points: 400 },

  // Anécdotas Legendarias (26-42)
  ...
  { id: 88, categoryId: 'anecdotas', q: 'Coki y sus amigos le pagaron un boleto de avión a este personaje para visitar a Tafich en Vancouver. ¿Quién era y qué dijo cuando finalmente lo corrió Tafich?', a: 'Manuel Pichón - "Aquí están tus llaves, tiradas a la suerte como me tiraste a mí, puñetas"', points: 450 },


  // Cultura Familiar (43-58)
  { id: 43, categoryId: 'cultura-familiar', q: '¿Qué juego de mesa jugábamos tradicionalmente en Año Nuevo?', a: 'Monopoly', points: 100 },
  { id: 44, categoryId: 'cultura-familiar', q: '¿Cómo se llama el libro que escribió Siti?', a: 'Rácimo de Cuentos', points: 150 },
  { id: 45, categoryId: 'cultura-familiar', q: '¿Cuáles eran los tacos favoritos del abuelito Chano y la Mawita?', a: 'El Palmito', points: 150 },
  { id: 46, categoryId: 'cultura-familiar', q: '¿Cómo se llama la hermana más chiquita de Siti?', a: 'Polly', points: 150 },
  { id: 47, categoryId: 'cultura-familiar', q: '¿Cómo le decía de cariño el abuelito Chano a Siti?', a: '"La hermana de la caridad"', points: 150 },
  { id: 48, categoryId: 'cultura-familiar', q: '¿Qué significa "marmaja"?', a: 'Dinero / Alguien con dinero', points: 200 },
  { id: 81, categoryId: 'cultura-familiar', q: '🎵 RETO MUSICAL: Canten la canción de Mapy que inventó Tío Neto', a: '"Ay María Paula... qué niña tan buena, yo la quiero mucho, mucho de verdad"', points: 200 },
  { id: 49, categoryId: 'cultura-familiar', q: '¿Qué palabra de la familia usamos para decir "naco"?', a: 'Chabuz', points: 200 },
  { id: 50, categoryId: 'cultura-familiar', q: 'Menciona UN plantillo que nunca faltaba los sábados en casa de Siti, hecho por Buch', a: 'Tostadas u Hojas de parra', points: 200 },
  { id: 51, categoryId: 'cultura-familiar', q: '¿Cómo le decimos de cariño a la tía Conchita y sus hijas, y por qué?', a: '"Las Tiburtinas" - porque viven en Via Tiburtina', points: 200 },
  { id: 52, categoryId: 'cultura-familiar', q: '¿Qué animal significa el apellido "Dieck" en árabe?', a: 'Gallo ديك', points: 250 },
  { id: 53, categoryId: 'cultura-familiar', q: '¿Qué animal significa el apellido "Assad" en árabe?', a: 'León أسد', points: 250 },
  { id: 54, categoryId: 'cultura-familiar', q: '¿Qué significa la palabra árabe "Haram"?', a: 'Pobrecito / Cositas', points: 250 },
  { id: 55, categoryId: 'cultura-familiar', q: '¿Quién inventó la expresión "casa todos"?', a: 'Coki', points: 250 },
  { id: 56, categoryId: 'cultura-familiar', q: '¿Qué familiar leía el futuro en los restos del café?', a: 'Siti', points: 250 },
  ...
  { id: 84, categoryId: 'cultura-familiar', q: '¿De qué trataba la obra de Navidad que actuamos de niños dirigida por Josephine y Lulita?', a: 'Un niño rico es llevado por ángeles a casa de una familia pobre para enseñarle que la Navidad no se trata de regalos', points: 300 },
  { id: 86, categoryId: 'cultura-familiar', q: 'En la obra de Navidad, ¿quiénes eran la familia rica y quiénes la familia pobre?', a: 'FAMILIA RICA: Neni, Samuel y Farid | FAMILIA POBRE: Flety, Mariangela y Marce', points: 300 },
  ...
  { id: 85, categoryId: 'lugares', q: '¿Cómo se llamaba el campamento de basquetbol al que íbamos de niños?', a: 'Spurs o Crusander', points: 300 },
  ...
  { id: 72, categoryId: 'personajes', q: '¿Qué tío formó un Cine Club del que muchos primos eran parte y se juntaban a ver películas?', a: 'Tío Pedro', points: 150 },
  ...
  { id: 89, categoryId: 'personajes', q: '🎙️ PREGUNTA FINAL: ¿Quién es el compañero de podcast del tío Mauricio?', a: 'Alex Porras', points: 400 }
];
